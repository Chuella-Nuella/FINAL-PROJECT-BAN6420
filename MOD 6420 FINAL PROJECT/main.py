...
from model.model import UserModelCreate, UserModelUpdate
...
def create_user():
    ...
    """
    try:
        # Extract user_data from the request JSCollectionON body
...
def update_user(user_id):
    """
    This routes updates the user using the update data
    """
